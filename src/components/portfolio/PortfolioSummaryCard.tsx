...
export function PortfolioSummaryCard({
  ...
  return (
    <article className="dark bg-hero-gradient rounded-xl border-0 shadow-ambient p-8 h-full">
      {/* Header */}
      ...
      {/* Main Value */}
      <div className="mb-8">
        <p className="text-5xl md:text-6xl font-mono font-bold tracking-tighter text-foreground">
